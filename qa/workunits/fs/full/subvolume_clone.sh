...
# The subvolume is snapshotted and clone ten times. Since the clone delay is set to 15 seconds,
...
# Hard cleanup
ignore_failures sudo rm -rf $CEPH_MNT/_index/clone/*
ignore_failures sudo rm -rf $CEPH_MNT/volumes/_nogroup/clone_*
ignore_failures sudo rmdir $CEPH_MNT/volumes/_nogroup/sub_0/.snap/snap_0
ignore_failures sudo rm -rf $CEPH_MNT/volumes/_nogroup/sub_0
