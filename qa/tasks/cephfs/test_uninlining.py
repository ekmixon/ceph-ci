...
class TestDataUninlining(CephFSTestCase):
    ...
    def get_inline_data_info(self, inodes: List[str]) -> List[InlineDataInfo]:
        info: List[InlineDataInfo] = []
        for inode in inodes:
    ...
    def test_data_uninlining(self) -> None:
        # Set max_mds to 2
