...
class TestSubvolumeGroups(TestVolumesHelper):
    ...
    def test_subvolume_group_quota_exceeded_subvolume_removal(self):
        ...
        try:
            time.sleep(15)
            # create 200 files of 1MB to exceed quota
            self._do_subvolume_io(subvolname, subvolume_group=group, number_of_files=200)
        except CommandFailedError:
            # Delete subvolume when group quota is exceeded
            self._fs_cmd("subvolume", "rm", self.volname, subvolname, "--group_name", group)
        else:
            self.fail("expected filling subvolume {0} with 200 files of size 1MB "
    ...
    def test_subvolume_group_resize_expand_on_full_subvolume(self):
        ...
        try:
            ...
            time.sleep(15)
            # create 75 files of 1MB
            self._do_subvolume_io(subvolname, subvolume_group=group, create_dir='dir1', number_of_files=75)
        except CommandFailedError:
            ...
            try:
                ...
                self.fail("expected filling subvolume {0} with 75 files of size 1MB "
